...
let hasPizza = false
let hasVegan = true
if hasVegan == true && (hasPizza == true || hasFish == true) {
  print("Let's go!")
} else {
...
let isRaining = true
let isSunny = true
var isNiceWeather: Bool = isRaining != true || temp >= 82 && isSunny == true
if isNiceWeather == true {
  print("I'm going for a walk!")
}
print("If you are reading this, I know that it is not possible for it to be sunny and raining at the same time in one location, but the intructions told me to say if it is not raining OR if it is sunny and 82° or above to say (I'm going for a walk)")
...
let currentHR = 147
var isBelowTarget: Bool = currentHR < targetLowerBound
var isAboveTarget: Bool = currentHR > targetUpperBound
var isInTarget: Bool = currentHR > targetLowerBound && currentHR < targetUpperBound
if isBelowTarget == true {
...
switch currentHR {
  case 0...99:
  print("You are too slow. You need to speed up")
  case 100...120:
  ...
  default:
  print("You are exceeding the maximum level. Slow down!")
}
